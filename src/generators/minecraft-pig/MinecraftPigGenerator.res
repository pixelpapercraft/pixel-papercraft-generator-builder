...
let textures: array<Generator.textureDef> = [
  ...
  {
    id: "Pig (Faithful)",
    url: Generator.requireImage("./textures/faithful/pig.png"),
    standardWidth: 64,
    standardHeight: 32,
  },
  {
  ...
  {
    id: "Pig (Space Pig)",
    url: Generator.requireImage("./textures/space-pig/pig.png"),
    standardWidth: 64,
    standardHeight: 32,
  },
  {
...
let script = () => {
  ...
  // Leg Function
  let drawLeg = (texture, x, y, labelID) => {
    ...
    if showLabels {
      drawSprite(labelSprite, sprite.contents, x + 32, y + 24)
    }
    if showTitles {
