...
let drawSimple = (showFolds: bool) => {
  ...
  Generator.drawTexture(
    "Minecart",
    minecart.bottom.back.rectangle,
    (ox - 32, oy, 160, 128),
    ~rotate=-90.0,
    (),
  )
  ...
  Generator.drawTexture("Minecart", minecart.sides.front.rectangle, (ox - 16, oy - 96, 128, 80), ())
  Generator.drawTexture(
    "Minecart",
    minecart.sides.back.rectangle,
    (ox - 16, oy - 160, 128, 64),
  ...
  Generator.drawTexture("Minecart", minecart.sides.back.rectangle, (ox - 16, oy + 224, 128, 64), ())
  Generator.drawTexture(
    "Minecart",
    minecart.bottom.left.rectangle,
    (ox + 40, oy + 232, 16, 128),
